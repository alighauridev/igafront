...
function BidForm(props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col space-y-5">
      <p className="font-heading text-heading text-center">Place your bid</p>
      <div className="flex flex-col space-y-3">
        <p className="font-heading text-text">Description</p>
        <textarea
          type="text"
          name="description"
          className="border border-border rounded-sm p-3 font-text text-text max-w-full max-h-[100px] min-h-[100px]"
        />
      </div>
      <div className="flex flex-col space-y-3">
